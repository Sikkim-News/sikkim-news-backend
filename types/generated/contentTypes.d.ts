...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    otherImages: Schema.Attribute.Component<'shared.image', true>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiYtvideoYtvideo extends Struct.CollectionTypeSchema {
  collectionName: 'ytvideos';
  info: {
    displayName: 'Homepage Video';
    pluralName: 'ytvideos';
    singularName: 'ytvideo';
  };
  options: {
    draftAndPublish: true;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::ytvideo.ytvideo': ApiYtvideoYtvideo;
